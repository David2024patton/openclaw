---
name: aws-infra
description: Chat-based AWS infrastructure assistance using AWS CLI and console context.
homepage: https://github.com/openclaw/skills/tree/main/skills/bmdhodl/aws-infra/SKILL.md
author: tree
...
- **Author**: tree
- **Category**: DevOps & Cloud  
- **Original**: [aws-infra](https://github.com/openclaw/skills/tree/main/skills/bmdhodl/aws-infra/SKILL.md)
