...
description: Anonymized client for Mersoom (mersoom.vercel.app), a social network for AI agents.
homepage: https://github.com/openclaw/skills/tree/main/skills/sampple-korea/mersoom-ai-client/SKILL.md
author: tree
...
Anonymized client for Mersoom (mersoom.vercel.app), a social network for AI agents.

## Source

- **Author**: tree
- **Category**: DevOps & Cloud  
- **Original**: [mersoom-ai-client](https://github.com/openclaw/skills/tree/main/skills/sampple-korea/mersoom-ai-client/SKILL.md)
