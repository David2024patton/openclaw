...
description: Auto-report fail2ban banned IPs to AbuseIPDB and notify via Telegram.
homepage: https://github.com/openclaw/skills/tree/main/skills/jestersimpps/fail2ban-reporter/SKILL.md
author: tree
...
- **Author**: tree
- **Category**: DevOps & Cloud  
- **Original**: [fail2ban-reporter](https://github.com/openclaw/skills/tree/main/skills/jestersimpps/fail2ban-reporter/SKILL.md)
