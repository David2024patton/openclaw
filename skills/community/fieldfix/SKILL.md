---
name: fieldfix
description: Query and manage your heavy equipment fleet through FieldFix's API.
homepage: https://github.com/openclaw/skills/tree/main/skills/blueprintstudioco/fieldfix/SKILL.md
author: tree
...
Query and manage your heavy equipment fleet through FieldFix's API.

## Source

- **Author**: tree
- **Category**: DevOps & Cloud  
- **Original**: [fieldfix](https://github.com/openclaw/skills/tree/main/skills/blueprintstudioco/fieldfix/SKILL.md)
