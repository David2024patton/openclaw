...
description: Cryptographic identity and continuity for AI agents.
homepage: https://github.com/openclaw/skills/tree/main/skills/zeph-ai-dev/identity-anchor/SKILL.md
author: tree
category: AI & LLMs
...
Cryptographic identity and continuity for AI agents.

## Source

- **Author**: tree
- **Category**: AI & LLMs  
- **Original**: [identity-anchor](https://github.com/openclaw/skills/tree/main/skills/zeph-ai-dev/identity-anchor/SKILL.md)
