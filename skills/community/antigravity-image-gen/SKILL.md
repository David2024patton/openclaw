...
description: Generate images using the internal Google Antigravity API (Gemini 3 Pro Image).
homepage: https://github.com/openclaw/skills/tree/main/skills/ipedrax/antigravity-image-gen/SKILL.md
author: tree
category: AI & LLMs
...
Generate images using the internal Google Antigravity API (Gemini 3 Pro Image).

## Source

- **Author**: tree
- **Category**: AI & LLMs  
- **Original**: [antigravity-image-gen](https://github.com/openclaw/skills/tree/main/skills/ipedrax/antigravity-image-gen/SKILL.md)
