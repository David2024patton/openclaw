...
description: Conflict detection and error monitoring for AI agents.
homepage: https://github.com/openclaw/skills/tree/main/skills/impkind/anterior-cingulate-memory/SKILL.md
author: tree
...
Conflict detection and error monitoring for AI agents.

## Source

- **Author**: tree
- **Category**: DevOps & Cloud  
- **Original**: [anterior-cingulate-memory](https://github.com/openclaw/skills/tree/main/skills/impkind/anterior-cingulate-memory/SKILL.md)
