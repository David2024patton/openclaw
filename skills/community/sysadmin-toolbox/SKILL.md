...
description: Tool discovery and shell one-liner reference for sysadmin, DevOps.
homepage: https://github.com/openclaw/skills/tree/main/skills/jdrhyne/sysadmin-toolbox/SKILL.md
author: tree
...
Tool discovery and shell one-liner reference for sysadmin, DevOps.

## Source

- **Author**: tree
- **Category**: DevOps & Cloud  
- **Original**: [sysadmin-toolbox](https://github.com/openclaw/skills/tree/main/skills/jdrhyne/sysadmin-toolbox/SKILL.md)
...
References auto-refresh weekly (Sundays
