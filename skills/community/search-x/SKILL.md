---
name: search-x
description: Search X/Twitter in real-time using Grok.
homepage: https://github.com/openclaw/skills/tree/main/skills/mvanhorn/search-x/SKILL.md
author: tree
category: AI & LLMs
...
Search X/Twitter in real-time using Grok.

## Source

- **Author**: tree
- **Category**: AI & LLMs  
- **Original**: [search-x](https://github.com/openclaw/skills/tree/main/skills/mvanhorn/search-x/SKILL.md)
