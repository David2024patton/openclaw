...
description: Control and operate Opencode via slash commands.
homepage: https://github.com/openclaw/skills/tree/main/skills/karatla/opencode-controller/SKILL.md
author: tree
category: AI & LLMs
...
- **Author**: tree
- **Category**: AI & LLMs  
- **Original**: [opencode-controller](https://github.com/openclaw/skills/tree/main/skills/karatla/opencode-controller/SKILL.md)
