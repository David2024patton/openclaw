---
name: xai
description: Chat with Grok models via xAI API.
homepage: https://github.com/openclaw/skills/tree/main/skills/mvanhorn/xai/SKILL.md
author: tree
category: AI & LLMs
...
- **Author**: tree
- **Category**: AI & LLMs  
- **Original**: [xai](https://github.com/openclaw/skills/tree/main/skills/mvanhorn/xai/SKILL.md)
