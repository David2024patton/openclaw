---
name: nano-triple
description: Generate 3 images with Nano Banana Pro using the same prompt.
homepage: https://github.com/openclaw/skills/tree/main/skills/mvanhorn/nano-triple/SKILL.md
author: tree
category: AI & LLMs
...
Generate 3 images with Nano Banana Pro using the same prompt.

## Source

- **Author**: tree
- **Category**: AI & LLMs  
- **Original**: [nano-triple](https://github.com/openclaw/skills/tree/main/skills/mvanhorn/nano-triple/SKILL.md)
