---
name: insula-memory
description: Internal state awareness for AI agents.
homepage: https://github.com/openclaw/skills/tree/main/skills/impkind/insula-memory/SKILL.md
author: tree
category: AI & LLMs
...
Internal state awareness for AI agents.

## Source

- **Author**: tree
- **Category**: AI & LLMs  
- **Original**: [insula-memory](https://github.com/openclaw/skills/tree/main/skills/impkind/insula-memory/SKILL.md)
