---
name: uptime-kuma
description: Interact with Uptime Kuma monitoring server.
homepage: https://github.com/openclaw/skills/tree/main/skills/msarheed/uptime-kuma/SKILL.md
author: tree
...
- **Author**: tree
- **Category**: DevOps & Cloud  
- **Original**: [uptime-kuma](https://github.com/openclaw/skills/tree/main/skills/msarheed/uptime-kuma/SKILL.md)
