---
name: godaddy
description: GoDaddy API for managing DNS records.
homepage: https://github.com/openclaw/skills/tree/main/skills/rdewolff/godaddy/SKILL.md
author: tree
...
GoDaddy API for managing DNS records.

## Source

- **Author**: tree
- **Category**: DevOps & Cloud  
- **Original**: [godaddy](https://github.com/openclaw/skills/tree/main/skills/rdewolff/godaddy/SKILL.md)
...
```bash
godaddy.sh dns add example.com --type A --name app --data 192.168.1.1 --
