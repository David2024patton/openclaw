---
name: nomad
description: Query HashiCorp Nomad clusters: jobs, nodes, allocations, services.
homepage: https://github.com/openclaw/skills/tree/main/skills/danfedick/nomad/SKILL.md
author: tree
...
- **Author**: tree
- **Category**: DevOps & Cloud  
- **Original**: [nomad](https://github.com/openclaw/skills/tree/main/skills/danfedick/nomad/SKILL.md)
