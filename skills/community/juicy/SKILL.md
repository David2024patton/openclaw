---
name: juicy
description: Complete Juicebox V5 protocol skills collection.
homepage: https://github.com/openclaw/skills/tree/main/skills/mejango/juicy/SKILL.md
author: tree
...
Complete Juicebox V5 protocol skills collection.

## Source

- **Author**: tree
- **Category**: DevOps & Cloud  
- **Original**: [juicy](https://github.com/openclaw/skills/tree/main/skills/mejango/juicy/SKILL.md)
