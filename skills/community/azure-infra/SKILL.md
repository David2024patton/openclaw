---
name: azure-infra
description: Chat-based Azure infrastructure assistance using Azure CLI and portal context.
homepage: https://github.com/openclaw/skills/tree/main/skills/bmdhodl/azure-infra/SKILL.md
author: tree
...
Chat-based Azure infrastructure assistance using Azure CLI and portal context.

## Source

- **Author**: tree
- **Category**: DevOps & Cloud  
- **Original**: [azure-infra](https://github.com/openclaw/skills/tree/main/skills/bmdhodl/azure-infra/SKILL.md)
