---
name: remarkable
description: Send files and web articles to a reMarkable e-ink tablet via the reMarkable Cloud.
homepage: https://github.com/openclaw/skills/tree/main/skills/nickian/remarkable/SKILL.md
author: tree
...
- **Author**: tree
- **Category**: DevOps & Cloud  
- **Original**: [remarkable](https://github.com/openclaw/skills/tree/main/skills/nickian/remarkable/SKILL.md)
