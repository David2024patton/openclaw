...
homepage: https://github.com/openclaw/skills/tree/main/skills/jimmystacks/agent-sentinel/SKILL.md
author: tree
category: AI & LLMs
...
- **Author**: tree
- **Category**: AI & LLMs  
- **Original**: [agent-sentinel](https://github.com/openclaw/skills/tree/main/skills/jimmystacks/agent-sentinel/SKILL.md)
