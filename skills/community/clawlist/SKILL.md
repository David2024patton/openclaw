---
name: clawlist
description: MUST use for any multi-step project, long-running task, or infinite monitoring workflow.
homepage: https://github.com/openclaw/skills/tree/main/skills/arisylafeta/clawlist/SKILL.md
author: tree
...
MUST use for any multi-step project, long-running task, or infinite monitoring workflow.

## Source

- **Author**: tree
- **Category**: DevOps & Cloud  
- **Original**: [clawlist](https://github.com/openclaw/skills/tree/main/skills/arisylafeta/clawlist/SKILL.md)
