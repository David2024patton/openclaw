---
name: recipe-to-list
description: Turn recipes into a Todoist Shopping.
homepage: https://github.com/openclaw/skills/tree/main/skills/borahm/recipe-to-list/SKILL.md
author: tree
category: AI & LLMs
...
Turn recipes into a Todoist Shopping.

## Source

- **Author**: tree
- **Category**: AI & LLMs  
- **Original**: [recipe-to-list](https://github.com/openclaw/skills/tree/main/skills/borahm/recipe-to-list/SKILL.md)
